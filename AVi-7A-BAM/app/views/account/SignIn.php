...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost/AVi-7A-BAM/public/Styles/SignIn.css">
    <meta lang="en-US">
    <title>Sign In</title>
</head>
    ...
    <main class="main-class">
        <div class="main">
            ...
            <form class="form1" action="<?php echo "http://localhost/AVi-7A-BAM/public/signin/login" ?>" method="POST">
                ...
                <p class="enter"><a href="CreateAccView.html">Don't have an account yet?<br>Create one!</p>
                </a>
            </form>
        </div>
    </main>
...
<nav class="navbar">
    ...
    <ul class="navbar-ul">
        ...
        <li class="navbar-item">
            ...
            <div class="nav-link" onclick="document.location.href='http://localhost/AVi-7A-BAM/public/CreateAccount'">
