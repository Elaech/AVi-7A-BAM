...
<body>
    <article>
		...
		<section>
			<h2>Tabel afisat dupa search</h2>
		...
		<section>
			<h2>Documentatie</h2>
			<p>Accesarea butonului Documentatie din bara de navigare va duce la pagina dedicata documentatiei proiectului.</p>
		</section>
		
		<section>
			<h2>Altele</h2>
			<p>Dupa 30 de minute sesiune sa va inchide iar utilizatorul va trebui sa se logheze din nou.</p>
			<p>Multe Intrari din tabelul accidente sunt nule, acest lucru se datoreaza golurile din setul de date initiale.</p>
		</section>
