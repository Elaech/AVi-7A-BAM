...
<body>
    ...
    <header>
        <div class="header-item1">
            <h1> <div onclick="document.location.href='http://localhost/AVi-7A-BAM/public/Home/index'">
...
<nav class="navbar">
    ...
    <ul class="navbar-ul">
        <li class="navbar-item" id="userButton">
            <a href="SignInView.html" class="nav-link">
                <img id="userImage"
        ...
        <li class="navbar-item">
            <a href="ContactPageViewNotLogged.html" class="nav-link">
