...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo Constants::CSS_STATISTICS; ?>">
    <script type="text/javascript" src="<?php echo Constants::JS_FILTRATION; ?>"></script>
    <meta lang="en-US">
    <!-- Script by Ionita Andra -->
    <title>Statistics</title>
    <script type="text/javascript" src="<?php echo Constants::JS_GOOGLE_CHART; ?>"></script>
