...
class Constants{
    ...
    const ACCOUNTMENU = "http://localhost/AVi-7A-BAM/public/AccountMenu";
    //HEADER LOCATION
    ...
    const NAV_DEFAULT_USERICON = "https://upload.wikimedia.org/wikipedia/commons/d/de/Windows_live_square.JPG";
    //TEXT RESOURCES
